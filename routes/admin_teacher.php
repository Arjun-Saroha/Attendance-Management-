    ...
    <div class="container">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand h1" href="#">Admin</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <li class="nav-item px-3">
                        <a class="nav-link" href="../routes/admin_login.php">Subject</a>
                    </li>
                    <li class="nav-item px-3">
                ...
                <div class="p-3">
                    <form>
                        <div class="form-row py-1">
                            ...
                            <div class="form-group col-md-6 px-4">
                            <input id="rdes" type="text" class="form-control" placeholder="Designation">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6 px-4">
                        ...
                        <div class="form-row py-1">
                            ...
                            <input type="button" onclick="addTeacher()" id="registerbtn" class="form-control btn btn-success" value="Register">
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <h3>Teachers</h3>
                <div class="py-3" id="teacherList"></div>
            </div>
        </div>
    </div>
</div>
