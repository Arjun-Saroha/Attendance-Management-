...
<head>
  ...
  <title>Admin Dashboard - Subject</title>
...
<div id="bodySection">
    <div class="container">
                ...
                <form>
                    <div class="form-row pt-3">
                        ...
                        <div class="form-group col-md-2">
                            <button class="btn btn-success form-control" style="background-color:green" type="button" onclick="addSubject()">Add +</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="py-3" id="subjectList"></div>
            </div>
        </div>
    </div>
</div>
